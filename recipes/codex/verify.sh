...
# and Notification registrations for notchify-agent-state.sh are
# still present. Returns nonzero if any were dropped (e.g. by
...
nr_hooks_verify "$NR_PREFIX/.codex/hooks.json" "$hook_path" Stop Notification
